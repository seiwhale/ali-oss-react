(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('antd/lib/upload/style'), require('antd/lib/upload'), require('antd/lib/button/style'), require('antd/lib/button'), require('antd/lib/icon/style'), require('antd/lib/icon'), require('antd/lib/message/style'), require('antd/lib/message'), require('core-js/modules/es6.function.name'), require('regenerator-runtime/runtime'), require('core-js/modules/es6.promise'), require('core-js/modules/es6.object.to-string'), require('react'), require('antd/dist/antd.css')) :
  typeof define === 'function' && define.amd ? define(['exports', 'antd/lib/upload/style', 'antd/lib/upload', 'antd/lib/button/style', 'antd/lib/button', 'antd/lib/icon/style', 'antd/lib/icon', 'antd/lib/message/style', 'antd/lib/message', 'core-js/modules/es6.function.name', 'regenerator-runtime/runtime', 'core-js/modules/es6.promise', 'core-js/modules/es6.object.to-string', 'react', 'antd/dist/antd.css'], factory) :
  (global = global || self, factory(global.dist = {}, null, global._Upload, null, global._Button, null, global._Icon, null, global._message, null, null, null, null, global.React));
}(this, (function (exports, style, _Upload, style$1, _Button, style$2, _Icon, style$3, _message, es6_function_name, runtime, es6_promise, es6_object_toString, React) { 'use strict';

  _Upload = _Upload && _Upload.hasOwnProperty('default') ? _Upload['default'] : _Upload;
  ...
  function (_React$Component) {
    ...
    _createClass(AliOssReact, [{
      ...
      value: function render() {
        ...
        return React.createElement(_Upload, _extends({}, this.DEFAULT_PROPS, rest), React.createElement(_Button, null, React.createElement(_Icon, {
          type: "upload"
        }), "\u4E0A\u4F20"));
      }
    }]);
